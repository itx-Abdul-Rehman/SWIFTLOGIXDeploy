...
const RiderDashboard = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await fetch('http://13.234.75.47:3000/rider-dashboard',
                    { credentials: 'include' }
                );
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                const response = await fetch('http://13.234.75.47:3000/get-deliveries',
                    {
                        method: 'POST',
                        credentials: 'include',
    ...
    const handleAccept = async (index) => {
        try {
            ...
            const response = await fetch('http://13.234.75.47:3000/assigned-delivery',
                {
                    method: 'POST',
                    credentials: 'include',
                    headers: { 'Content-Type': 'application/json' },
    ...
    useEffect(() => {
        const riderPickedShipments = async () => {
            try {
                const response = await fetch("http://13.234.75.47:3000/check-pick-shipment",
                    {
                        credentials: 'include'
                    }
                )
