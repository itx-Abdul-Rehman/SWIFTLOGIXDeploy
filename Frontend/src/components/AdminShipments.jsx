...
const AdminShipments = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const response = await fetch('http://13.203.194.4:3000/get-city-shipments',
        {
          method: 'POST',
          credentials: 'include',
  ...
  const handleDroppedShipments = async (index) => {
    try {
      ...
      const response = await fetch('http://13.203.194.4:3000/dropped-shipment',
        {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
  ...
  const pickedShipment = async (index) => {
    try {
      ...
      setProcessingIndex(index)
      const response = await fetch("http://13.203.194.4:3000/rider-picked",
        {
          method: 'POST',
          credentials: 'include',
          headers: { 'Content-Type': 'application/json' },
  ...
  const handleFilterPickByRider = async (date, time) => {
    try {
      ...
      const response = await fetch('http://13.203.194.4:3000/get-shipment-pickbyrider',
        {
          method: 'POST',
          credentials: 'include',
          headers: { 'Content-Type': 'application/json' },
  ...
  const sendEmailNotification = async () => {
    try {
      const response = await fetch('http://13.203.194.4:3000/send-notification', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
