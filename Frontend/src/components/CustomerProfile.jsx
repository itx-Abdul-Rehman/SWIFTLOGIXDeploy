...
const CustomerProfile = () => {
  ...
  const handleSave = async () => {
    if (validateEditData()) {
      try {
        setIsResponse(false)
        const response = await fetch(`${import.meta.env.VITE_API_URL}/verifyedit-customer`,
          {
            method: 'POST',
            credentials: 'include',
  ...
  const saveEditDetails = async () => {
    try {
      const response = await fetch(`${import.meta.env.VITE_API_URL}/saveedit-customer`,
        {
          method: 'PUT',
          credentials: 'include',
          headers: { 'Content-Type': 'application/json' },
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch(`${import.meta.env.VITE_API_URL}/customer-profile`,
          { credentials: 'include' }
        );
        const result = await response.json();
  ...
  const saveCnic = async () => {
    ...
    try {
      const response = await fetch(`${import.meta.env.VITE_API_URL}/add-cnic`,
        {
          method: 'PATCH',
          credentials: 'include',
          headers: { 'Content-Type': 'application/json' },
  ...
  const saveAddress = async () => {
    try {
      ...
      const response = await fetch(`${import.meta.env.VITE_API_URL}/add-address`,
        {
          method: 'PATCH',
          credentials: 'include',
          headers: { 'Content-Type': 'application/json' },
